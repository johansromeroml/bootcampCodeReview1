...
func (a *ServerChi) Run() (err error) {
	...
	rt.Route("/vehicles", func(rt chi.Router) {
		...
		rt.Get("/average_speed/brand/{brand}", hd.GetAvgSpeedByBrand())

		rt.Post("/", hd.PostVehicle())
		rt.Post("/batch", hd.PostVehicleGroup())

		rt.Put("/{id}/update_speed", hd.PutUpdateMaxSpeed())
